...
class DeskSelection extends React.PureComponent {
    ...
    render() {
        const { classes, desks, desk, setDesk, deskType, filter, teacher, groupDesk } = this.props;
...
DeskSelection = withStyles(styles)(DeskSelection);

DeskSelection = connect(({desks, me}) => ({
